...
<div style="display: flex; flex-wrap:wrap; align-items: center; justify-content: center;">
  <a
    ...
    style="text-decoration:none;border:0;width:56px;height:56px;padding:0;margin:3px;color:#ffffff;"
    ><svg
      class="niftybutton-email"
  ...
  >
  <a
    href="https://www.facebook.com/halovair"
    target="_blank"
    rel="noopener noreferrer"
    style="text-decoration:none;border:0;width:56px;height:56px;padding:0;margin:3px;color:#ffffff;"
    ><svg
  ...
  ><a
    href="https://www.tiktok.com/@halovair"
    target="_blank"
    rel="noopener noreferrer"
    style="text-decoration:none;border:0;width:56px;height:56px;padding:0;margin:3px;color:#ffffff;"
    ><svg
      class="niftybutton-tiktok"
      style="display:block;fill:currentColor"
      data-donate="true"
      data-tag="tic"
      data-name="TikTok"
  ...
  ><a
    href="https://www.instagram.com/halovair/"
    target="_blank"
    rel="noopener noreferrer"
    style="text-decoration:none;border:0;width:56px;height:56px;padding:0;margin:3px;color:#ffffff;"
    ><svg
  ...
  ><a
    href="https://www.youtube.com/channel/UCCz07gPaFYIYyRNJMfLUyTw"
    target="_blank"
    rel="noopener noreferrer"
    style="text-decoration:none;border:0;width:56px;height:56px;padding:0;margin:3px;color:#ffffff;"
    ><svg
  ...
  ><a
    href="https://open.spotify.com/artist/4qjr6ECyk3yhokw8onrIAu"
    target="_blank"
    rel="noopener noreferrer"
    style="text-decoration:none;border:0;width:56px;height:56px;padding:0;margin:3px;color:#ffffff;"
    ><svg
  ...
  >
  <a
    href="https://halovair.bandcamp.com/"
    target="_blank"
    rel="noopener noreferrer"
    style="text-decoration:none;border:0;width:56px;height:56px;padding:0;margin:3px;color:#ffffff;"
    ><svg
